			...
			<section class="wrap-login-form">
				<form class="login-form" action="/signup" method="post" onsubmit="return validateForm()">
					...
					<div class="login-input-layout">
						...
						<input id="repw" name="repw" type="password" placeholder="입력한 비밀번호를 재입력하세요." required />
					</div>
					...
					<div class="login-input-layout">
						...
						<input id="phone" name="phone" type="tel" placeholder="전화번호를 입력하세요." required />
					</div>
					...
					<div class="check-sex">
						<label>성별:</label>
						<input type="radio" name="sex" value="male" required> 남성
						<input type="radio" name="sex" value="female" required> 여성
					</div>
					
					<div class="login-input-layout">
						<label for="height"> 키 (cm): </label> 
						<input id="height" name="height" type="number" placeholder="키를 입력하세요." />
					</div>
					
					<div class="login-input-layout">
						<label for="weight"> 몸무게 (kg): </label> 
						<input id="weight" name="weight" type="number" placeholder="몸무게를 입력하세요." />
					</div>
